...
[ПРОМПТ ДЛЯ ГЕНЕРАЦИИ: Инфографика "Пирамида проектирования баз данных". Три уровня (Концептуальный, Логический, Физический) показаны в виде слоев, где верхний слой — это абстракция (ER-диаграмма), средний — таблицы и связи, нижний — жесткие диски и бинарный код. Стрелка указывает направление "Top-Down".]
...
#### Сценарий 1: каждыйеширование агрегатов (Счетчики)
